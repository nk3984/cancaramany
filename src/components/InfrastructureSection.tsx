...
export function InfrastructureSection() {
  ...
  const copies = [
    contentFacts.infrastructure.water,
    contentFacts.infrastructure.electricity,
    contentFacts.infrastructure.access,
  ];
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        ...
        <FadeIn className="mt-12 max-w-3xl border-t border-[var(--color-warm-stone)]/70 pt-10">
          <p className="text-[11px] uppercase tracking-[0.24em] text-[var(--color-deep-olive)]">
            {dict.infrastructure.historicTitle}
          </p>
          <p className="mt-4 text-sm leading-relaxed text-[var(--color-deep-olive)]">
            {dict.infrastructure.historicCopy}
          </p>
        </FadeIn>
      ...
      <Modal
        ...
        title={dict.infrastructure.modalTitle}
      >
