      ...
      <p className="mt-4 max-w-lg text-sm leading-relaxed text-[var(--color-deep-olive)]">
        {isDe ? (
          ...
          <>
            ...
            to enable the interactive location map.
          </>
        )}
      </p>
    </div>
