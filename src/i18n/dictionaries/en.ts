...
export const en: Dictionary = {
  ...
  brand: {
    ...
    tortoiseNote:
      "The tortoise — a traditional Mallorcan symbol of fortune — is the mark of Can Caramany.",
    locationLine: "Mallorca · Spain",
  ...
  hero: {
    eyebrow: "Private Estate · Mallorca",
    lead: "Space. Privacy. Heritage. Mallorca.",
    meta: "Four private landholdings · 235,000+ m² · 58+ acres · Historic finca",
    cta: "Explore the Estate",
    scroll: "Scroll",
  },
  statement: {
    eyebrow: "The Estate",
  ...
  estateStats: {
    ...
    heritage: "Historic finca",
    location: "Eastern Mallorca",
  },
  masterplan: {
  ...
  propertiesSection: {
    eyebrow: "Properties",
    headline: "Four landholdings. Four architectural beginnings.",
    lead: "Each property is offered in its own right — a substantial piece of Mallorcan countryside, and the original project once drawn for it. Together they form Can Caramany. Separately, each is a complete private world.",
  },
  heritage: {
  ...
  landscape: {
    eyebrow: "Landscape",
    headline: "The landscape is the luxury.",
    lead: "This is what luxury looks like here: ancient holm oaks, almond and olive trees, dry-stone walls that have held the land for generations, and light that moves across the same ground from morning until evening. The estate does not imitate rural Mallorca. It is rural Mallorca — private, unhurried, and unusually intact.",
    captions: {
      fields: "Open land",
      planting: "Mediterranean planting",
      path: "Estate paths",
      oaks: "Holm oaks",
      wall: "Dry-stone walls",
    },
  },
  residences: {
  ...
  location: {
    eyebrow: "Location",
    headline: "Secluded. Not Isolated.",
    p1: "Can Caramany sits in the municipality of Manacor, in Mallorca’s eastern hinterland — among farms, vineyards and open countryside, eight kilometres from town and within easy reach of Porto Cristo and Portocolom.",
    p2: "It is the rare combination buyers look for and so seldom find: the privacy and scale of a true country estate, without giving up the island’s harbours, restaurants and everyday ease.",
    loadingMap: "Loading map…",
    estateLabel: "CAN CARAMANY",
    estateSubtitle: "Private Estate · Municipality of Manacor",
    filters: {
      all: "All",
      everyday: "Everyday",
      coast: "Coast",
  ...
  closing: {
    ...
    cta: "Arrange a Private Conversation",
    modalTitle: "Arrange a Private Conversation",
  },
  enquiry: {
    intro:
      "Qualified buyers, advisers and investment partners are invited to request a private conversation regarding Can Caramany.",
    ...
    consentAfter:
      "and consent to the processing of my personal data for the purpose of handling my enquiry.",
    submit: "Submit Enquiry",
    sending: "Sending…",
    thanksTitle: "Thank you.",
    thanksBody: "Your enquiry has been received. A private response will follow.",
    interests: {
      "Private Purchase": "Private Purchase",
  ...
  properties: {
    "property-i": {
      ...
      areaNote:
        "Area figures provisional pending current Registro / Catastro confirmation.",
    },
    "property-ii": {
      label: "Property II",
  ...
  propertyIii: {
    ...
    factsNote: "Historically documented land area for Parcelas 391 + 393.",
    existing: {
      ...
      levels: [
        {
          ...
          copy: "Approx. 194.70 m² in the original proposal — entrance, salon and living spaces opening toward the land.",
        },
        {
          label: "Upper floor",
          title: "Private retreat",
          copy: "Approx. 156.05 m² in the original proposal — private rooms within the contemplated upper-floor extension.",
        },
        {
          label: "Outdoors",
          title: "Living in the landscape",
          copy: "Approx. 296.55 m² outdoor / terrace areas and an approx. 63.75 m² pool in the original proposal.",
        },
      ],
      figures: [
        {
  ...
  propertyPage: {
    ...
    positionHeadline: "One of four private opportunities at Can Caramany.",
    positionHeadlineIii: "The architectural heart of four private opportunities.",
    historicEyebrow: "Historic Finca",
    historicHeadline: "A house that was here before us.",
    historicCopy:
      "At the heart of Can Caramany stands a traditional Mallorcan finca. Its surviving structures tell the story of the land and offer a rare architectural anchor for the future.",
    existing: "Existing",
    originalProposal: "Original Proposal",
    privateDocs: "Private Documentation",
    requestInfo: "Request detailed information for Property",
  ...
  legal: {
    ...
    imprint: {
      title: "Imprint",
      metaDescription:
        "Legal imprint for GENI BALEAR S.L.U., operator of the Can Caramany website.",
      intro:
        "Information pursuant to applicable Spanish and EU information requirements for the website of Can Caramany.",
      ...
      sections: [
        {
          ...
          body: [
            "The controller responsible for personal data processed via this website is GENI BALEAR S.L.U. (GENI BALEAR S.L.), NIF/CIF B-57091464, C/ Arquitecto Francisco Casas 17, local A06, 07181 Calvià, Baleares (Illes), Spain. Email: info@cancaramany.com. Phone: +49 170 3232013.",
          ],
        },
        {
          heading: "2. Purposes of processing",
          body: [
            "We process personal data for the following purposes: handling contact enquiries and requests for a private conversation; handling data-room / documentation access requests; operating, securing and improving the website; displaying the interactive location map (Mapbox), where a map token is configured; and complying with legal obligations.",
          ],
        },
        {
          heading: "3. Categories of data",
          body: [
            "Depending on your use of the site, this may include: name; email address; telephone number (if provided); company, country and interest category; message content and preferred property / enquiry type; and technical data such as IP address, browser/device information and logs related to hosting and map usage.",
          ],
        },
        {
          heading: "4. Legal bases",
          body: [
            "Processing is based on your consent (where requested via the enquiry form), our legitimate interest in operating a professional project website and responding to business enquiries, and/or compliance with legal obligations, as applicable under the GDPR and Spanish data protection law (LOPDGDD).",
          ],
        },
        {
          heading: "5. Recipients / processors",
          body: [
            "Data may be processed by service providers acting on our behalf: hosting via Vercel (or equivalent); maps via Mapbox (map display; technical transmission of IP / device information depending on implementation); and enquiry delivery via Resend (transactional email delivery of contact and data-room enquiries to info@cancaramany.com).",
          ],
        },
        {
          heading: "6. Retention",
          body: [
            "Enquiry and data-room request data is retained only as long as needed to handle the request and any related legitimate interest or legal requirement, then deleted or anonymised.",
          ],
        },
        {
          heading: "7. Your rights",
          body: [
            "You may have the right to access, rectify, erase, restrict, object to, or port your personal data, and to withdraw consent where processing is based on consent. You may also lodge a complaint with the Agencia Española de Protección de Datos (AEPD).",
          ],
        },
        {
          heading: "8. Cookies and similar technologies",
          body: [
            "Essential technical storage may be required for site operation. If analytics or non-essential cookies are introduced later, this policy and any consent mechanism will be updated accordingly.",
          ],
        },
        {
          heading: "9. Related information",
          body: [
            "See also the Legal Disclaimer and Imprint for further information about this website and its operator.",
          ],
        },
      ],
    },
    disclaimer: {
      ...
      operatorBody:
        "This website is operated by GENI BALEAR S.L.U. (GENI BALEAR S.L.). See the Imprint for company details and the Privacy notice for data protection information.",
    },
  },
};
